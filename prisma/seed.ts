  ...
  for (const article of publishedArticles) {
    ...
    await prisma.post.upsert({
      ...
      update: {
        ...
        imageCaption: "Daily Signal Wire editorial image.",
        imageDisclosure: null,
        imageSourceType: "placeholder",
        imageLicense: "Original editorial image",
      ...
      create: {
        ...
        seoDescription: article.excerpt.slice(0, 165),
        facebookCaption: article.excerpt,
        imagePrompt: `Realistic editorial news image about ${article.focus}; no logos, no text, not documentary photography.`,
        imageUrl: article.image,
        featuredImageUrl: article.image,
        featuredImage: article.image,
        thumbnailImage: article.image,
...
async function seedDraftWorkflow() {
  ...
  await prisma.post.upsert({
    ...
    create: {
      ...
      imagePrompt:
        "Realistic editorial news image of an abstract technology news cycle, modern American newsroom style, not documentary photography, no logos, no text.",
      imageSourceType: "placeholder",
      imageStatus: "idle",
      aiGenerated: true,
      factCheckNotes: JSON.stringify([
